...
function Dashboard() {
  ...
  const fetchAnalytics = async (retryCount = 0) => {
    ...
    try {
      const response = await axios.get(`http://localhost:3001/api/tenants/${tenantId}/analytics`, {
        headers: { Authorization: `Bearer ${token}` },
      });
      
      const ordersResponse = await axios.get(`http://localhost:3001/api/tenants/${tenantId}/orders`, {
        headers: { Authorization: `Bearer ${token}` },
        params: { limit: 1000 }
      });
  ...
  const fetchRiders = async () => {
    ...
    try {
      const response = await axios.get(`http://localhost:3001/api/tenants/${tenantId}/riders`, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const fetchOrders = async () => {
    ...
    try {
      ...
      const response = await axios.get(`http://localhost:3001/api/tenants/${tenantId}/orders`, {
        headers: { Authorization: `Bearer ${token}` },
        params,
      });
  ...
  useEffect(() => {
    ...
    const fetchTenant = async () => {
      ...
      try {
        const response = await axios.get(`http://localhost:3001/api/tenants/${tenantId}`, {
          headers: { Authorization: `Bearer ${token}` },
        });
    ...
    const fetchMenuItems = async () => {
      try {
        const response = await axios.get(`http://localhost:3001/api/tenants/${tenantId}/menu-items`, {
          headers: { Authorization: `Bearer ${token}` },
        });
  ...
  const handleAddOrder = async () => {
    ...
    try {
      const response = await axios.post(`http://localhost:3001/api/tenants/${tenantId}/orders`, orderData, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const handleUpdateOrder = async () => {
    ...
    try {
      const response = await axios.put(`http://localhost:3001/api/tenants/${tenantId}/orders/${editOrder.order_id}`, orderData, {
        headers: { Authorization: `Bearer ${token}` },
      });
      if (response.data.success) {
        await fetchOrders();
  ...
  const handleStatusChange = async (orderId, newStatus) => {
    ...
    try {
      const response = await axios.put(`http://localhost:3001/api/tenants/${tenantId}/orders/${orderId}`, orderData, {
        headers: { Authorization: `Bearer ${token}` },
      });
      if (response.data.success) {
        await fetchOrders();
  ...
  const handleCancelOrder = async (orderId) => {
    ...
    try {
      const response = await axios.put(`http://localhost:3001/api/tenants/${tenantId}/orders/${orderId}`, {
        status: 'canceled',
      }, {
        headers: { Authorization: `Bearer ${token}` },
      });
  ...
  const handleExportOrders = async () => {
    ...
    try {
      const params = { status: filterStatus, sortBy, sortOrder, search: searchQuery };
      const response = await axios.get(`http://localhost:3001/api/tenants/${tenantId}/orders/export`, {
        headers: { Authorization: `Bearer ${token}` },
        params,
        responseType: 'blob',
      });
